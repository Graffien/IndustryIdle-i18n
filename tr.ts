export const TR = {
    ...
    MaxInputDistance: "Maksimum çıkış mesafesi",
    MaxInputDistanceDesc:
        "Bu binanın giriş kaynaklarını alabileceği maksimum mesafe, fayans sayısı cinsinden ölçülür",
    AutoSellConcurrency: "Otomatik Kaynak Satışı",
    AutoSellConcurrencyDesc: "Otomatik satış için aynı anda maksimum kaynak sayısı",
    MaxAutoSellConcurrencyReached:
        "Maksimum otomatik satış eş zamanına ulaştınız, bunu etkinleştirmek için başka bir otomatik satışı kapatın",
    WallStreet: "Borsa Merkezi",
    MarketCap: "Piyasa Değeri",
    MarketCapDesc: "Kurumunuzun toplam pazar sermayesi (örn. Piyasa değeri)",
    BuildingValuation: "Yapılarınızın değeri",
    BuildingValuationDesc: "Bina izinleri ve yükseltmeler dahil binalarınızın toplam değeri",
    ResourcesValuation: "Kaynaklarınızın Değeri",
    ...
    StockRatingDesc:
        "Wall Street analistlerinden hisse senedi derecelendirme konsensüsü, pazar notunuzu etkiler ve pazarla birlikte güncellenir",
    OfflineEarning: "Çevrimdışı Kazanç",
    PerMin: "%{amount}/dakika",
    OfflineEarningTime: "Çevrimdışı Kazanç Süresi",
    OfflineEarningTimeDesc: "Bu süre eşiğine kadar çevrimdışı puan kazanacaksınız",
    BuyPermit: "İzin Satın Al",
    Settings: "Ayarlar",
    Sound: "Ses Efekti",
    SoundDesc: "Tıklama veya hata sesi gibi ses efektini açar",
    MusicDesc: "Müziği açın: It's Not Over 'Til The Bossa Nova by Shane Ivers (https://www.silvermansound.com)",
    Credits: "Credits",
    Icons: "İkonlar",
