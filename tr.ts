export const TR = {
    ...
    ExpansionPacks: "Genişleme Paketi",
    ExpansionPack1: "Genişleme Paketi 1",
    RequireExpansionPack1: "Genişleme Paketi 1",
    ...
    HideChat: "Konuşmaları gizle",
    PurchaseFailed: "Satın alma gerçekleştirilemedi",
    PurchaseSteamContinue: "Please finish your purchase on Steam",
    PurchaseSuccess: "Tebrikler! Satın alma başarılı, Bize destek verdiğiniz için teşekkür ederiz.",
    ...
    LoadGameError: "Yüklenirken hata oluştu.",
    LoadGameErrorMessage: "Hata: %{message}",
    LoadGameErrorDesc: "Lütfen internet bağlantınızı kontrol edin. Sorun devam ediyorsa destek hattımıza ulaşın.",
    ...
    Hamburg: "Hamburg",
    HamburgBonus:
        "<li>Zeplin fabrikası açık.</li><li>Semiconductor factories have 2x productivity</li><li>Shipyards have 2x capacity</li><li>Car factories have 2x capacity</li><li>Li-ion battery factories are unlocked</li>",
    Toulouse: "Toulouse",
    Rome: "Roma",
    RomeBonus:
    ...
    HongKong: "Hong Kong",
    FreeTransportToTradeCenter: "Uluslar arası İhracat Merkezi",
    ...
    SteamAutoCloudBackup: "Otomatik olarak Bulut'a kaydet",
    SteamAutoCloudBackupFailed: "Bulut'a kayıt edilemedi: %{error}",
    ...
    SaveAndExit: "Kaydet ve çıkış yap",
    SaveAndExitDesc:
    ...
    BattleshipFactory: "Battleship Fabrikası",
    ResourceMovementHide: "Herşeyi Gizle",
    ResourceMovementShow: "Herşeyi Göster",
    ...
    PanelPositionLeft: "Sol (Docked)",
    PanelPositionLeftFloat: "Sol (Float)",
    PanelPositionRight: "Sağ (Docked)",
    PanelPositionRightFloat: "Sağ (Float)",
    PanelPositionAuto: "Otomatik",
    TimePlayed: "Oyun Zamanı",
    ...
    AirForce: "Air Force",
    StealthFighterFactory: "Hayalet Uçak Fabrikası",
    StealthFighter: "Hayalet Uçak",
    ...
    PlayerTradeFilterBestPrice: "En Uygun Fiyat",
    ...
    BuildingSourceFallbackSkip: "Geç",
    ...
    Perth: "Perth",
    GV: "Geothermal Vent",
    GeothermalPowerPlant: "Geotermal Enerji Tesisi",
    ...
    CapacitorFactory: "Kapasitör Fabrikası",
    Capacitor: "Kapasitör",
    ...
    Pizza: "Pizza",
    StreamingStartRecord: "Kayıt Başla",
    ...
    StartInANewCity: "Yeni Şehirde Başla",
